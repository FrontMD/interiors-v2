document.addEventListener('DOMContentLoaded', function() {
    const descr = document.querySelector('.about-joinTeam__content-top__descr');
    const showBtn = document.querySelector('.about-joinTeam__show-btn');
